...
class MyTopologia(Topo):
   def build(self, **_kwargs):
      r0 = self.addNode("r0", cls=Router) #Aggiunta del router
      switch1 = self.addSwitch("s1")#Aggiunta del primo switch
      ...
      switch2 = self.addSwitch("s2")#Aggiunta del secondo switch
